...
svConfig.Webhook = '' -- Your Webhook Link

svConfig.AfterHeistCooldown = 60 -- Seconds |  How long after someone did a heist should the cooldown be active (Global Cooldown)

svConfig.RewardItem = { --  / Each Difficulty has different Rewards
