...
if Config.Menu == 'oxlib' then
    lib.registerContext({
        id = 'medical_heistmenu',
        title = 'Medical Heist',
        menu = 'some_menu',
        icon = 'user',
        options = {
            {
                title = Translation[Config.Locale]['easy'],
                description = Translation[Config.Locale]['desc_easy'],
                icon = 'box',
                iconColor = '46ab0c',
                progress = 100,
                colorScheme = '#46ab0c',
            ...
            {
                title = Translation[Config.Locale]['normal'],
                description = Translation[Config.Locale]['desc_normal'],
                icon = 'box',
                iconColor = 'e6c41e',
                onSelect = function()
                    if Config.Framework == 'ESX' then 
            ...
            {
                title = Translation[Config.Locale]['hard'],
                description = Translation[Config.Locale]['desc_hard'],
                icon = 'box',
                iconColor = 'ad0e0e',
                onSelect = function()
                    if Config.Framework == 'ESX' then 
